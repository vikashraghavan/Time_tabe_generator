...
public class inputdata {
	...
	public static double crossoverrate = 1.0, mutationrate = .5;
	public static int nostudentgroup, noteacher;
	public static int hoursperday, daysperweek=5;
	...
	/*public void takeinput()// takes input from file input.txt
	{
		...
		daysperweek = 5;
		try {
			File file = new File("C:\\Users\\aakas\\IdeaProjects\\pit_timetable\\src\\sample\\input.txt");
			...
			while (scanner.hasNextLine()) {
				...
				if (line.equalsIgnoreCase("teachers")) {
					...
					while (!(line = scanner.nextLine()).equalsIgnoreCase("end")) {
						...
						teacher[i].subject[0] = st.nextToken();
